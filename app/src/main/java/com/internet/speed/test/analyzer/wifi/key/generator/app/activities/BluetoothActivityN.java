...
public class BluetoothActivityN extends AppCompatActivity {

    private static final String TAG = "BluetoothActivityN";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ArrayAdapter<String>(BluetoothActivityN.this, android.R.layout.simple_list_item_1, arrayListpaired);
        detectedAdapter = new ArrayAdapter<String>(BluetoothActivityN.this, android.R.layout.simple_list_item_single_choice);
    ...
    private void initViews() {
        btnOnOff = findViewById(R.id.btnSwitch_on_off);
    ...
    private void getPairedDevices() {
        if (!arrayListpaired.isEmpty()) {
            arrayListpaired.clear();
        }
        if (!arrayListPairedBluetoothDevices.isEmpty()) {
    ...
    class ListItemClicked implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            // TODO Auto-generated method stub
            if (!arrayListBluetoothDevices.isEmpty()) {
                bluetoothDevice = arrayListBluetoothDevices.get(position);
            }else {
                Log.i("Log", "Zeeshan: " +"arrayListBluetoothDevices is empty");
            }
    ...
    class ListItemClickedonPaired implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            try {
                Boolean removeBonding = removeBond(bluetoothDevice);
                if (removeBonding) {
    ...
    private void startSearching() {
        ...
        BluetoothActivityN.this.registerReceiver(myReceiver, intentFilter);
    ...
    private void makeDiscoverable() {
        ...
        Toast.makeText(getApplicationContext(), "Bluetooth will be Discoveable for 300 seconds" +
